...
static const st7703_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    {0xB2, (uint8_t []){0x00, 0x03, 0x70}, 3, 0},

    {0xB3, (uint8_t []){0x10, 0x10, 0xFC, 0xFC, 0x03, 0xFF, 0x00, 0x00, 0x00, 0x00}, 10, 0},
    {0xB4, (uint8_t []){0x80}, 1, 0},
    {0xB5, (uint8_t []){0x0A, 0x0A}, 2, 0},
    {0xB6, (uint8_t []){0x8E, 0x8E}, 2, 0},
    ...
    {0xC1, (uint8_t []){0x53, 0x00, 0x32, 0x32, 0x77, 0xD1, 0xCC, 0xCC, 0x77, 0x77, 0x33, 0x33}, 12, 0},
