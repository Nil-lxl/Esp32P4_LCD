...
//  {cmd, { data }, data_size, delay_ms}
    ...
    {0x17, (uint8_t []){0x10}, 1, 0},
    {0x18, (uint8_t []){0x0F}, 1, 0},
    {0x19, (uint8_t []){0x01}, 1, 0},
    {0x1A, (uint8_t []){0x10}, 1, 0},
    ...
    {0x57, (uint8_t []){0x65}, 1, 0},
    {0x59, (uint8_t []){0x0A}, 1, 0},
    {0x5A, (uint8_t []){0x28}, 1, 0},
    {0x5B, (uint8_t []){0x0F}, 1, 0},


    {0x5D, (uint8_t []){0x7C}, 1, 0},
    {0x5E, (uint8_t []){0x64}, 1, 0},
    {0x5F, (uint8_t []){0x53}, 1, 0},
    {0x60, (uint8_t []){0x45}, 1, 0},
    {0x61, (uint8_t []){0x3E}, 1, 0},
    {0x62, (uint8_t []){0x2E}, 1, 0},
    {0x63, (uint8_t []){0x31}, 1, 0},
    {0x64, (uint8_t []){0x19}, 1, 0},
    {0x65, (uint8_t []){0x31}, 1, 0},
    {0x66, (uint8_t []){0x30}, 1, 0},
    {0x67, (uint8_t []){0x2E}, 1, 0},
    {0x68, (uint8_t []){0x4A}, 1, 0},
    {0x69, (uint8_t []){0x35}, 1, 0},
    {0x6A, (uint8_t []){0x3B}, 1, 0},
    {0x6B, (uint8_t []){0x2C}, 1, 0},
    {0x6C, (uint8_t []){0x2A}, 1, 0},
    {0x6D, (uint8_t []){0x1F}, 1, 0},
    {0x6E, (uint8_t []){0x13}, 1, 0},
    {0x6F, (uint8_t []){0x0C}, 1, 0},
    {0x70, (uint8_t []){0x7C}, 1, 0},
    {0x71, (uint8_t []){0x64}, 1, 0},
    {0x72, (uint8_t []){0x53}, 1, 0},
    {0x73, (uint8_t []){0x45}, 1, 0},
    {0x74, (uint8_t []){0x3E}, 1, 0},
    {0x75, (uint8_t []){0x2E}, 1, 0},
    {0x76, (uint8_t []){0x31}, 1, 0},
    {0x77, (uint8_t []){0x19}, 1, 0},
    {0x78, (uint8_t []){0x31}, 1, 0},
    {0x79, (uint8_t []){0x30}, 1, 0},
    {0x7A, (uint8_t []){0x2E}, 1, 0},
    {0x7B, (uint8_t []){0x4A}, 1, 0},
    {0x7C, (uint8_t []){0x35}, 1, 0},
    {0x7D, (uint8_t []){0x3B}, 1, 0},
    {0x7E, (uint8_t []){0x2C}, 1, 0},
    ...
    {0x63, (uint8_t []){0x1C}, 1, 0},
    {0x64, (uint8_t []){0x6A}, 1, 0},
    {0x65, (uint8_t []){0x75}, 1, 0},
    {0x66, (uint8_t []){0x0F}, 1, 0},
    {0x67, (uint8_t []){0x73}, 1, 0},
    {0x68, (uint8_t []){0x0D}, 1, 0},
    ...
    {0x02, (uint8_t []){0x23}, 1, 0},
    {0x09, (uint8_t []){0x10}, 1, 0},
    {0x0E, (uint8_t []){0x4A}, 1, 0},
    {0x36, (uint8_t []){0x49}, 1, 0},
