...
#if (CONFIG_IDF_TARGET_ESP32S3 || CONFIG_IDF_TARGET_ESP32P4) && CONFIG_LCD_USE_RGB_INTERFACE && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 0, 0)
#include "esp_lcd_panel_rgb.h"
#endif

#if ((CONFIG_IDF_TARGET_ESP32P4 && CONFIG_LCD_USE_MIPI_INTERFACE) && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 3, 0))
